...
def make_coco_transforms_random(image_set):
...
def build(image_set, args):
    ...
    dataset = CocoDetection(img_folder, ann_file, transforms=make_coco_transforms_random(image_set), return_masks=args.masks)
    return dataset
